...
<p>
This will have you practice several topics from the last few weeks to
create and style a credit card submission form. Our form will be
inspired by this
...
<pre><code class="lang-markup">&lt;img
class="card-image"
